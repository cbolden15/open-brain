...
B2 led to the bounded component experiment below. Its failed artifacts remain failed.

## NW0-B3 result: component isolation works; adoption remains open

The [B3 component record](../audits/2026-09-09-ob1-nw0-b3-markdown-component.md) separates root
context, lazy language exports, sanitization and discovery constants in a private eight-file patch.
The combined archive is 9,892,018 bytes with seven Graphify modules; both combined and helper
archives pass unchanged content inspection and Mac signature checks. The combined native smoke
passes, and the observed repeat-series startup delta is 103 ms. Controlled cold starts remain open.

Nine frozen fixture cases preserve the original root-aware raw output; 83 source checks and 73
evidence checks pass. The focused upstream tests report 46 passed and one failed on both original
